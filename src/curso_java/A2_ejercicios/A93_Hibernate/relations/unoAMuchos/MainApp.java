package curso_java.A2_ejercicios.A93_Hibernate.relations.unoAMuchos;


import curso_java.A2_ejercicios.A93_Hibernate.relations.unoAMuchos.entities.Libro;
...
public class MainApp {
	...
	public static void main(String[] args) {
		 ...
		 */
		EntityManager em = UtilsHibernate.getEM("hibernateOracle");
